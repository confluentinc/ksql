...
* Bare bones API server ([#4320](https://github.com/confluentinc/ksql/pull/4320)) ([7a8ba8c](https://github.com/confluentinc/ksql/commit/7a8ba8c))
...
* Integrate reactive streams TCK and improvements to our reactive streams implementations ([#4354](https://github.com/confluentinc/ksql/pull/4354)) ([0edfd24](https://github.com/confluentinc/ksql/commit/0edfd24))
...
* Use AbstractConfig for API server config ([#4357](https://github.com/confluentinc/ksql/pull/4357)) ([457b3cd](https://github.com/confluentinc/ksql/commit/457b3cd))
* Use POJOs to represent JSON objects read/written from wire ([#4358](https://github.com/confluentinc/ksql/pull/4358)) ([f06c9b2](https://github.com/confluentinc/ksql/commit/f06c9b2))
* Use POJOs to represent JSON objects read/written from wire ([#4379](https://github.com/confluentinc/ksql/pull/4379)) ([1c174fe](https://github.com/confluentinc/ksql/commit/1c174fe))
...
* add test topology rewriter ([#4204](https://github.com/confluentinc/ksql/pull/4204)) ([665f207](https://github.com/confluentinc/ksql/commit/665f207))
...
* add .vscode/ and .factorypath to .gitignore ([#4035](https://github.com/confluentinc/ksql/pull/4035)) ([1199662](https://github.com/confluentinc/ksql/commit/1199662))
...
* plan serialization jackson annotations ([#3520](https://github.com/confluentinc/ksql/pull/3520)) ([2736d77](https://github.com/confluentinc/ksql/commit/2736d77))
...
* Fixes ImmutabilityTest to run on new types.  Also simplifies lag object structure ([#4417](https://github.com/confluentinc/ksql/pull/4417)) ([3677d5f](https://github.com/confluentinc/ksql/commit/3677d5f))
...
* Make host status map entries in Heartbeat Handler immutable ([#4418](https://github.com/confluentinc/ksql/pull/4418)) ([399c732](https://github.com/confluentinc/ksql/commit/399c732))
...
* pin the jetty client version ([#4324](https://github.com/confluentinc/ksql/pull/4324)) ([7640b43](https://github.com/confluentinc/ksql/commit/7640b43))
...
* Remove duplicate maven dependencies that cause warnings during build ([#4490](https://github.com/confluentinc/ksql/pull/4490)) ([563d600](https://github.com/confluentinc/ksql/commit/563d600))
* Remove unecessarily timout in PullQueryRoutingFunctionalTest ([#4492](https://github.com/confluentinc/ksql/pull/4492)) ([12f4317](https://github.com/confluentinc/ksql/commit/12f4317))
* Remove unncecessary @AfterClass cleanup in LagReportingAgentFunctionalTest which is causing flakiness ([#4429](https://github.com/confluentinc/ksql/pull/4429)) ([e422b77](https://github.com/confluentinc/ksql/commit/e422b77))
