...
common {
    ...
    maxBuildsToKeep = 99
    maxDaysToKeep = 90
    extraBuildArgs = isPrJob ? "-Dmaven.gitcommitid.nativegit=true" : "-T4 -Dassembly.skipAssembly -Dmaven.gitcommitid.skip -Dmaven.site.skip -Dprofile -DprofileFormat=CONSOLE"
}
