...
* **[Connect](https://docs.ksqldb.io/en/latest/concepts/connectors)** - Integrate with any of [Kafka Connect](https://docs.confluent.io/current/connect/index.html) data source or sink, entirely from within ksqlDB
