...
!!! Tip "See CREATE TABLE in action"
    ...
    - [Flag Unhealthy IoT Devices](https://confluentinc.github.io/ksqldb-recipes/anomaly-detection/internet-of-things/#ksqldb-code)
...
don't need to declare them manually.
