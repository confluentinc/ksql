...
named `users` and uses the example data from the ksql-datagen tool. For more
information, see [Generate custom test data](test-and-debug/generate-custom-test-data.md).
