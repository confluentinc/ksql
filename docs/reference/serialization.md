...
The following keywords aren't supported in JSON value schema fields for INSERT
INTO and CREATE TABLE AS SELECT statements, and if present in your schema will
cause serialization errors. They are supported in CREATE statements.
