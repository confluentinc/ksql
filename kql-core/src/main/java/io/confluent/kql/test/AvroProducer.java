...
public class AvroProducer {
  ...
  public List<String> genericRowOrderStream(String orderKafkaTopicName) {
    long maxInterval = 10;
  ...
  public void genericRowUserStream() {
    long maxInterval = 10;
    int messageCount = 100;
  ...
  public void genericRowPageViewStream() {
    long maxInterval = 10;
    int messageCount = 1000;
...
//  public void generateWikiSample() {
//    String schemaStr = "{"
//                       + "\"namespace\": \"kql\","
//                       + " \"name\": \"pageview\","
//                       + " \"type\": \"record\","
