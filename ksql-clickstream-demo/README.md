...
- [Follow these instructions if you are using Docker](/docker-clickstream.md)
- [Follow these instructions if you are not using Docker](/non-docker-clickstream.md)
