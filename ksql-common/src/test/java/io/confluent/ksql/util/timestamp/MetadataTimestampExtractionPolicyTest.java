...
public class MetadataTimestampExtractionPolicyTest {
  ...
  private final MetadataTimestampExtractionPolicy policy = new MetadataTimestampExtractionPolicy();


  @Test
  public void shouldSetTimestampExtractorToFailOnInvalidTimestamp() {
    policy.applyTo(config, properties);
    assertThat(properties.get(StreamsConfig.DEFAULT_TIMESTAMP_EXTRACTOR_CLASS_CONFIG),
        equalTo(FailOnInvalidTimestamp.class));
  }
