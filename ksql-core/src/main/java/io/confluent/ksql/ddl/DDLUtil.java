...
public class DDLUtil {
    ...
    public void createTopic(String topicName, int numPartitions, int replicationFactor) {
        ...
        try {
            ...
            zkClient.createPersistent(ZK_ENTITY_CONFIG_PATH + "/" + topicName, data, ZooDefs.Ids.OPEN_ACL_UNSAFE);
        } catch (JsonProcessingException e) {
            throw new StreamsException("Error while creating topic config in ZK for internal topic " + topicName, e);
        }
        ...
        try {
            ...
            throw new StreamsException("Error while creating topic metadata in ZK for internal topic " + topicName, e);
        }
