...
public class KsqlContextTest {
  ...
  public void shouldRunSimpleStatements() throws Exception {
    ...
    expect(ksqlEngine.buildMultipleQueries(false, statement1, Collections.emptyMap(), new QueryId(0)))
        .andReturn
        (Collections.emptyList());
    expect(ksqlEngine.buildMultipleQueries(false, statement2, Collections.emptyMap(), new QueryId(1)))
        .andReturn(getQueryMetadata(new QueryId(1), DataSource.DataSourceType.KSTREAM));
