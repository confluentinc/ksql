...
public class SqlToJavaVisitorTest {
  ...
  public void shouldGenerateCorrectCodeForCaseStatement() {
    ...
    // ThenL
    assertThat(javaExpression, equalTo("(java.lang.String)SearchedCaseFunction.searchedCaseFunction(ImmutableList.of( SearchedCaseFunction.whenClause( new java.util.function.Supplier<Boolean>() { @Override public Boolean get() { return ((((Object)(ORDERS_ORDERUNITS)) == null || ((Object)(Integer.parseInt(\"10\"))) == null) ? false : (ORDERS_ORDERUNITS < Integer.parseInt(\"10\"))); }},  new java.util.function.Supplier<java.lang.String>() { @Override public java.lang.String get() { return \"small\"; }}),SearchedCaseFunction.whenClause( new java.util.function.Supplier<Boolean>() { @Override public Boolean get() { return ((((Object)(ORDERS_ORDERUNITS)) == null || ((Object)(Integer.parseInt(\"100\"))) == null) ? false : (ORDERS_ORDERUNITS < Integer.parseInt(\"100\"))); }},  new java.util.function.Supplier<java.lang.String>() { @Override public java.lang.String get() { return \"medium\"; }})), new java.util.function.Supplier<java.lang.String>() { @Override public java.lang.String get() { return \"large\";}})"));
  }
