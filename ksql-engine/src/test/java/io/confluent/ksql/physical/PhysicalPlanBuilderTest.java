...
public class PhysicalPlanBuilderTest {
  ...
  private static final String createStream =
      "CREATE STREAM TEST1 (COL0 BIGINT, COL1 VARCHAR, COL2 DOUBLE) WITH ( "
  ...
  public void shouldFailIfInsertSinkDoesNotExist() {
    ...
    expectedException
        .expect(statementText(is("INSERT INTO s1 SELECT col0, col1, col2 FROM test1;")));
