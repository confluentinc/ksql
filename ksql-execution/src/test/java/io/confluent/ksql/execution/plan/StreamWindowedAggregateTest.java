...
public class StreamWindowedAggregateTest {
  ...
  private static final ExecutionStepPropertiesV1 PROPERTIES =
      new ExecutionStepPropertiesV1(new Stacker().push("foo").getQueryContext());
  private static final KsqlWindowExpression WINDOW = mock(KsqlWindowExpression.class);
