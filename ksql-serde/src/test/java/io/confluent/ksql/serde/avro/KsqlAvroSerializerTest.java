...
import static io.confluent.ksql.util.KsqlConstants.DEFAULT_AVRO_SCHEMA_FULL_NAME;
...
public class KsqlAvroSerializerTest {
  ...
  public void shouldThrowIfNotStruct() {
    ...
    // Then:
    assertThat(e.getCause(), hasMessage(containsString("java.lang.Integer cannot be cast to org.apache.kafka.connect.data.Struct")));
  }
  ...
  public void shouldThrowIfNotBoolean() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for BOOLEAN: class java.lang.Integer"))));
  }
  ...
  public void shouldThrowIfNotInt() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for INT32: class java.lang.Boolean"))));
  }
  ...
  public void shouldThrowIfNotBigInt() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for INT64: class java.lang.Boolean"))));
  }
  ...
  public void shouldThrowIfNotDouble() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for FLOAT64: class org.apache.kafka.connect.data.Struct"))));
  }
  ...
  public void shouldThrowIfNotString() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for STRING: class org.apache.kafka.connect.data.Struct"))));
  }
  ...
  public void shouldThrowIfNotArray() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("java.lang.Boolean cannot be cast to java.util.List"))));
  }
  ...
  public void shouldThrowOnWrongElementType() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for BOOLEAN: class java.lang.String"))));
  }
  ...
  public void shouldThrowIfNotMap() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("java.lang.Boolean cannot be cast to java.util.Map"))));
  }
  ...
  public void shouldThrowIfKeyWrongType() {
    ...
    // Then:
    assertThat(e.getCause(), (hasMessage(is("Invalid type for STRING: class java.lang.Integer"))));
  }
  ...
  public void shouldThrowOnMapSchemaWithNonStringKeys() {
    ...
    final PersistenceSchema physicalSchema = unwrappedPersistenceSchema(
        map(OPTIONAL_INT32_SCHEMA, INT32_SCHEMA)
            .build()
    );
    ...
    final Exception e = assertThrows(
        ...
        () -> new KsqlAvroSerdeFactory(DEFAULT_AVRO_SCHEMA_FULL_NAME)
            .createSerde(
                physicalSchema,
                ksqlConfig,
  ...
  public void shouldThrowOnNestedMapSchemaWithNonStringKeys() {
    ...
    final PersistenceSchema physicalSchema = unwrappedPersistenceSchema(
        struct()
            .field("f0", map(OPTIONAL_INT32_SCHEMA, INT32_SCHEMA)
                .optional()
                .build())
            .build()
    );
