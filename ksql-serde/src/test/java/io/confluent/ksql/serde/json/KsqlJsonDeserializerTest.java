...
public class KsqlJsonDeserializerTest {
  ...
  private final KsqlJsonDeserializer deserializer = new KsqlJsonDeserializer(schema);

  @Test
  public void shouldReturnNullForBadDataByDefault() {
    assertThat(deserializer.deserialize("topic", "hello".getBytes()), nullValue());
  }
  ...
  public void shouldThrowSerializationExceptionWhenFailOnErrorIsTrue() {
    ...
    deserializer.deserialize("topic", "hello".getBytes());
  }
