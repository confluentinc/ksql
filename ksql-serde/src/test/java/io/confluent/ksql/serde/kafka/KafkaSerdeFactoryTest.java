...
public class KafkaSerdeFactoryTest {
  ...
  public void shouldThrowOnValidateIfBoolean() {
    ...
    // Then:
    assertThat(e.getMessage(), containsString(
        "The 'KAFKA' format does not support type 'BOOLEAN'"
    ));
  }
  ...
  public void shouldThrowOnValidateIfDecimal() {
    ...
    // Then:
    assertThat(e.getMessage(), containsString(
        "The 'KAFKA' format does not support type 'DECIMAL'"
    ));
  }
  ...
  public void shouldThrowOnValidateIfArray() {
    ...
    // Then:
    assertThat(e.getMessage(), containsString(
        "The 'KAFKA' format does not support type 'ARRAY'"
    ));
  }
  ...
  public void shouldThrowOnValidateIfMap() {
    ...
    // Then:
    assertThat(e.getMessage(), containsString(
        "The 'KAFKA' format does not support type 'MAP'"
    ));
  }
  ...
  public void shouldThrowOnValidateIfStruct() {
    ...
    // Then:
    assertThat(e.getMessage(), containsString(
        "The 'KAFKA' format does not support type 'STRUCT'"
    ));
  }
