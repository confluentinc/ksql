...
public class QueryMask {
  ...
  private final String maskedQuery;

  private static final ImmutableSet<String> ALLOWED_KEYS = ImmutableSet.of("connector.class");
  private static final ImmutableSet<String> DISALLOWED_KEYS = ImmutableSet.of("connection.url",
      "mode", "topic.prefix", "table.whitelist", "key");
  private static final String MASKED_VALUE = "'[string]'";

  public QueryMask(final KsqlRequest request) {
    maskedQuery = getMaskedStatement(request.getKsql());
  ...
  private String getMaskedStatement(final String query) {
    try {
  ...
  private String maskConnectProperties(final String query) {
    /*
