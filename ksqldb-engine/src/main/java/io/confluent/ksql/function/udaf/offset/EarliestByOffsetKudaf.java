...
public class EarliestByOffsetKudaf extends BaseAggregateFunction<Object, Struct, Object> {
  ...
  public EarliestByOffsetKudaf(
    ...
    super(functionName,
        initArgs.udafIndex(),
        () -> null, // Here, the initial value is set to null.  In aggregate, we replace it.
        aggregateType,
        returnType,
        Collections.singletonList(
            new ParameterInfo("val",
                SchemaConverters.sqlToFunctionConverter().toFunctionType(returnType),"", false)),
        DESCRIPTION);
