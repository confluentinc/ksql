...
public class EarliestByOffsetKudaf extends BaseAggregateFunction<Object, Struct, Object> {
  ...
  public EarliestByOffsetKudaf(
    ...
    super(EarliestByOffsetFactory.FUNCTION_NAME, initArgs.udafIndex(), () -> null,
        aggregateType,
        returnType, Collections.singletonList(
  ...
  public Struct aggregate(final Object currentValue, final Struct aggregateValue) {
    ...
    return
        KudafByOffsetUtils.createStruct(internalStructSchema, generateSequence(), currentValue);
  }
