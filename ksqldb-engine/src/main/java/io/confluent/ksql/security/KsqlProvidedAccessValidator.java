...
public class KsqlProvidedAccessValidator implements KsqlAccessValidator {
  private static final IllegalArgumentException NO_PRINCIPAL_PRESENT_EXCEPTION =
      new IllegalArgumentException("User principal is not present");
  ...
  public void checkTopicAccess(
    ...
    authorizationProvider.checkPrivileges(
        securityContext.getUserPrincipal().orElseThrow(() -> NO_PRINCIPAL_PRESENT_EXCEPTION),
