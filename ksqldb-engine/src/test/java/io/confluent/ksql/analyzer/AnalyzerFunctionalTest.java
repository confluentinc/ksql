...
public class AnalyzerFunctionalTest {
  ...
  public void init() {
    ...
    analyzer = new Analyzer(jsonMetaStore, "", ROWPARTITION_ROWOFFSET_ENABLED, PULL_LIMIT_CLAUSE_ENABLED, UNWRAP_PROTOBUF_PRIMITIVES);
  ...
  public void shouldUseExplicitNamespaceForAvroSchema() {
    ...
    final Analyzer analyzer = new Analyzer(jsonMetaStore, "", ROWPARTITION_ROWOFFSET_ENABLED, PULL_LIMIT_CLAUSE_ENABLED, UNWRAP_PROTOBUF_PRIMITIVES);
  ...
  public void shouldUseExplicitNamespaceWhenFormatIsInheritedForAvro() {
    ...
    final Analyzer analyzer = new Analyzer(avroMetaStore, "", ROWPARTITION_ROWOFFSET_ENABLED, PULL_LIMIT_CLAUSE_ENABLED, UNWRAP_PROTOBUF_PRIMITIVES);
    final Analysis analysis = analyzer.analyze(query, Optional.of(createStreamAsSelect.getSink()));
  ...
  public void shouldNotInheritNamespaceExplicitlySetUpstreamForAvro() {
    ...
    final Analyzer analyzer = new Analyzer(newAvroMetaStore, "", ROWPARTITION_ROWOFFSET_ENABLED, PULL_LIMIT_CLAUSE_ENABLED, UNWRAP_PROTOBUF_PRIMITIVES);
    final Analysis analysis = analyzer.analyze(query, Optional.of(createStreamAsSelect.getSink()));
