...
public class StatementRewriteForMagicPseudoTimestampTest {
  ...
  public void shouldReplaceComparisonOfWindowStartAndString() {
    ...
    // Then:
    assertThat(rewritten.toString(), is(String.format("(ORDERS.WINDOWSTART > %d)", A_TIMESTAMP)));
  }
  ...
  public void shouldReplaceComparisonOfWindowEndAndString() {
    ...
    // Then:
    assertThat(rewritten.toString(), is(String.format("(ORDERS.WINDOWEND > %d)", A_TIMESTAMP)));
  }
  ...
  public void shouldReplaceBetweenWindowStartAndStrings() {
    ...
    assertThat(
        rewritten.toString(),
        is(String.format("(ORDERS.WINDOWSTART BETWEEN %d AND %d)", A_TIMESTAMP, ANOTHER_TIMESTAMP))
    );
  }
  ...
  public void shouldReplaceBetweenWindowEndAndStrings() {
    ...
    assertThat(
        rewritten.toString(),
        is(String.format("(ORDERS.WINDOWEND BETWEEN %d AND %d)", A_TIMESTAMP, ANOTHER_TIMESTAMP))
    );
  }
  ...
  public void shouldReplaceBetweenOnMinString() {
    ...
    assertThat(
        rewritten.toString(),
        is(String.format("(ORDERS.WINDOWSTART BETWEEN %d AND 1236987)", A_TIMESTAMP))
    );
  }
  ...
  public void shouldReplaceBetweenOnMaxString() {
    ...
    assertThat(
        rewritten.toString(),
        is(String.format("(ORDERS.WINDOWEND BETWEEN 1236987 AND %d)", A_TIMESTAMP))
    );
  }
