...
public class DefaultFormatInjectorTest {
  ...
  public void shouldInjectMissingKeyFormat() {
    ...
    // Then
    assertThat(result.getMaskedStatement().toString(), containsString("KEY_FORMAT='KAFKA'"));
  }
  ...
  public void shouldInjectMissingValueFormat() {
    ...
    // Then
    assertThat(result.getMaskedStatement().toString(), containsString("VALUE_FORMAT='JSON'"));
  }
