...
public class SandboxedPersistentQueryEntityImplTest {
  ...
  private SandboxedPersistentQueryEntityImpl sandbox;
  ...
  public void setUp() {
    ...
    final PersistentQueryEntityImpl query = new PersistentQueryEntityImpl(
        SQL,
        physicalSchema,
    ...
    sandbox = SandboxedPersistentQueryEntityImpl.of(query, sandboxListener);
    reset(kafkaStreams);
  }
