...
public class SqlToJavaVisitor {
  ...
  private class Formatter
      implements ExpressionVisitor<Pair<String, SqlType>, SqlToJavaTypeContext> {
    ...
    public Pair<String, SqlType> visitLambdaExpression(
        final LambdaFunctionCall lambdaFunctionCall, final SqlToJavaTypeContext context) {
      return visitUnsupported(lambdaFunctionCall);
    }

    @Override
    public Pair<String, SqlType> visitLambdaLiteral(
        final LambdaLiteral lambdaLiteral, final SqlToJavaTypeContext context) {
