...
@Immutable
public class StreamGroupByV1<K> implements ExecutionStep<KGroupedStreamHolder> {
  ...
  private static final ImmutableList<Property> MUST_MATCH = ImmutableList.of(
      ...
      new Property("group by clause", s -> ((StreamGroupByV1<?>) s).groupByExpressions),
      new Property("internal formats", s -> ((StreamGroupByV1<?>) s).internalFormats)
  );
  ...
  public void validateUpgrade(@Nonnull final ExecutionStep<?> to) {
    ...
    getSource().validateUpgrade(((StreamGroupByV1<?>) to).source);
  }
  ...
  public boolean equals(final Object o) {
    ...
    final StreamGroupByV1<?> that = (StreamGroupByV1<?>) o;
