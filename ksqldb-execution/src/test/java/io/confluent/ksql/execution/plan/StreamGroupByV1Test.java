...
public class StreamGroupByV1Test {
  @Mock
  ...
  public void shouldImplementEquals() {
    new EqualsTester()
        .addEqualityGroup(
            new StreamGroupByV1<>(properties1, source1, formats1, expression1),
            new StreamGroupByV1<>(properties1, source1, formats1, expression1))
        .addEqualityGroup(new StreamGroupByV1<>(properties2, source1, formats1, expression1))
        .addEqualityGroup(new StreamGroupByV1<>(properties1, source2, formats1, expression1))
        .addEqualityGroup(new StreamGroupByV1<>(properties1, source1, formats2, expression1))
        .addEqualityGroup(new StreamGroupByV1<>(properties1, source1, formats1, expression2))
        .testEquals();
  }
}