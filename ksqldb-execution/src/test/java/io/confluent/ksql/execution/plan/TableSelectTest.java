...
//    new EqualsTester()
//        .addEqualityGroup(
//            new TableSelect<>(properties1, source1, keys1, selectedKeys1, selects1, internalFormats1),
//            new TableSelect<>(properties1, source1, keys1, selectedKeys1, selects1, internalFormats1)
//        )
//        .addEqualityGroup(new TableSelect<>(properties2, source1, keys1, selectedKeys1, selects1, internalFormats1))
//        .addEqualityGroup(new TableSelect<>(properties1, source2, keys1, selectedKeys1, selects1, internalFormats1))
//        .addEqualityGroup(new TableSelect<>(properties1, source1, keys2, selectedKeys1, selects1, internalFormats1))
//        .addEqualityGroup(new TableSelect<>(properties1, source1, keys1, selectedKeys2, selects2, internalFormats1))
//        .addEqualityGroup(new TableSelect<>(properties1, source1, keys1, Optional.empty(), selects2, internalFormats1))
//        .addEqualityGroup(new TableSelect<>(properties1, source1, keys1, selectedKeys1, selects1, internalFormats2))
//        .testEquals();
//  }
//}