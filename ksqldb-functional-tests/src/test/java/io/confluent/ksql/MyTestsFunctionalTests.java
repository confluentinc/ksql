...
import io.confluent.ksql.test.rest.batches.RestQueryTranslationTestBatch0;
import io.confluent.ksql.test.rest.batches.RestQueryTranslationTestBatch1;
import io.confluent.ksql.test.rest.batches.RestQueryTranslationTestBatch2;
...
// Tries to load pom.xml
//        TestCasePlanLoaderTest.class,
        RestQueryTranslationTestBatch0.class,
        RestQueryTranslationTestBatch1.class,
        RestQueryTranslationTestBatch2.class,
