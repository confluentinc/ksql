...
--@expected.error: io.confluent.ksql.util.KsqlException
--@expected.message: StreamGroupByV1 must have matching group by clause. Values differ: [COL1, COL2] vs. [COL2, COL1]
----------------------------------------------------------------------------------------------------
SET 'ksql.create.or.replace.enabled' = 'true';
...
----------------------------------------------------------------------------------------------------
--@test: GROUP BY - change grouping column ordering - multicol enabled
--@expected.error: io.confluent.ksql.util.KsqlException
...
----------------------------------------------------------------------------------------------------
SET 'ksql.multicol.key.format.enabled' = 'true';
SET 'ksql.create.or.replace.enabled' = 'true';
