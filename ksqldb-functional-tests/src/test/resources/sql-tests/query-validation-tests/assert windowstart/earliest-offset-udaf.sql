--@test: earliest-offset-udaf - earliest by offset with arrays, structs, and maps
...
--@test: earliest-offset-udaf - earliest by offset with maps
...
--@test: earliest-offset-udaf - earliest by offset with structs
...
--@test: earliest-offset-udaf - earliest by offset with an array added
...
--@test: earliest-offset-udaf - earliest by offset
...
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0) AS L0, EARLIEST_BY_OFFSET(F1) AS L1, EARLIEST_BY_OFFSET(F2) AS L2, EARLIEST_BY_OFFSET(F3) AS L3, EARLIEST_BY_OFFSET(F4) AS L4, EARLIEST_BY_OFFSET(F5) AS L5, EARLIEST_BY_OFFSET(F6) AS L6, EARLIEST_BY_OFFSET(F7) AS L7, EARLIEST_BY_OFFSET(F8) AS L8 FROM INPUT GROUP BY ID;
...
INSERT INTO `INPUT` (ID, F0, F1, F2, F3, F4, F5, F6, F7, F8) VALUES (0, 21, 2000, 2.23, false, 'foo', '1970-01-01T00:00:00.034', '00:00', '1976-06-03', 'Yg==');
INSERT INTO `INPUT` (ID, F0, F1, F2, F3, F4, F5, F6, F7, F8) VALUES (1, 21, 2000, 2.23, false, 'foo', '1970-01-01T00:00:00.034', '00:00', '1976-06-03', 'Yg==');
...
--@test: earliest-offset-udaf - earliest by offset with decimals
...
--@test: earliest-offset-udaf - null first - single - ignoring nulls
...
--@test: earliest-offset-udaf - null first - multiple - ignoring nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
ASSERT VALUES `OUTPUT` (ID, L0) VALUES (0, ARRAY[13]);

--@test: earliest-offset-udaf - null first - single - not ignoring nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
--@test: earliest-offset-udaf - null first - multiple - not ignoring nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2, false) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
INSERT INTO `INPUT` (ID, F0) VALUES (0, 13);
ASSERT VALUES `OUTPUT` (ID, L0) VALUES (0, ARRAY[NULL]);
ASSERT VALUES `OUTPUT` (ID, L0) VALUES (0, ARRAY[NULL, 13]);

--@test: earliest-offset-udaf - nulls later - single - nulls ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0) AS L0 FROM INPUT GROUP BY ID;
...
--@test: earliest-offset-udaf - nulls later - multiple - nulls ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, 12);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - null later - single - nulls not ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, false) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, 12);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - null later - multiple - nulls not ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2, false) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, 12);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - earliest by offset with all nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - earliest n by offset
...
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2) AS L0, EARLIEST_BY_OFFSET(F1, 2) AS L1, EARLIEST_BY_OFFSET(F2, 2) AS L2, EARLIEST_BY_OFFSET(F3, 2) AS L3, EARLIEST_BY_OFFSET(F4, 2) AS L4 FROM INPUT GROUP BY ID;
...
INSERT INTO `INPUT` (ID, F0, F1, F2, F3, F4) VALUES (0, 31, 3000, 3.23, false, 'baz');
...
--@test: earliest-offset-udaf - earliest n by offset with nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0,2) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, 12);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - earliest n by offset with all nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0,2) AS L0 FROM INPUT GROUP BY ID;
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
INSERT INTO `INPUT` (ID, F0) VALUES (0, NULL);
...
--@test: earliest-offset-udaf - merging session windows
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1, 1500, 0, 1500);

--@test: earliest-offset-udaf - merging session windows - with nulls ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, 1, 1500);
...
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1, 1500, 1500, 1500);
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 0, 0, 0);
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1500, 1500, 1500);
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1, 1500, 0, 1500);

--@test: earliest-offset-udaf - merging session windows - with nulls not ignored
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
--@test: earliest-offset-udaf - merging session windows - all nulls
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, false) AS L0 FROM INPUT WINDOW SESSION (1 SECONDS) GROUP BY ID;
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, NULL, 0);
...
--@test: earliest-offset-udaf - merging session windows - with nulls ignored - N
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2, true) AS L0 FROM INPUT WINDOW SESSION (1 SECONDS) GROUP BY ID;
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, NULL, 0);
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, 1, 1500);
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, NULL, 700);
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, ARRAY[], 0, 0, 0);
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, ARRAY[1], 1500, 1500, 1500);
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 0, 0, 0);
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1500, 1500, 1500);
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, ARRAY[1], 1500, 0, 1500);

--@test: earliest-offset-udaf - merging session windows - with nulls not ignored - N
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
...
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 0, 0, 0);
ASSERT VALUES `OUTPUT` (ID, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, 1500, 1500, 1500);
ASSERT VALUES `OUTPUT` (ID, L0, ROWTIME, WINDOWSTART, WINDOWEND) VALUES (0, ARRAY[NULL, 1], 1500, 0, 1500);

--@test: earliest-offset-udaf - merging session windows - all nulls - N
CREATE STREAM INPUT (ID BIGINT KEY, F0 INT) WITH (kafka_topic='test_topic', value_format='JSON');
CREATE TABLE OUTPUT AS SELECT ID, EARLIEST_BY_OFFSET(F0, 2, false) AS L0 FROM INPUT WINDOW SESSION (1 SECONDS) GROUP BY ID;
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, NULL, 0);
INSERT INTO `INPUT` (ID, F0, ROWTIME) VALUES (0, NULL, 1500);
