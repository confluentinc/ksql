...
public final class TombstoneFactory {
  ...
  public static TombstoneFactory create(final TransientQueryEntity query) {
  ...
  private static ImmutableMap<Integer, Integer> buildKeyIdx(
      final TransientQueryEntity query
  ) {
  ...
  private static List<ColumnName> keyColumnNames(final TransientQueryEntity query) {
