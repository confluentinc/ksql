...
public class ProcessingLogErrorMetricFunctionalTest {
  ...
  public void shouldVerifyMetrics() {
	...
	final MetricName processingLogErrorMetricName1 = new MetricName(
		QueryMetricsUtil.PROCESSING_LOG_ERROR_METRIC_NAME,
		QueryMetricsUtil.PROCESSING_LOG_METRICS_GROUP_NAME,
		QueryMetricsUtil.PROCESSING_LOG_METRIC_DESCRIPTION,
		metricsTagsForQuery1
	);
	System.out.println("test");
	System.out.println(metricsTagsForQuery1);
