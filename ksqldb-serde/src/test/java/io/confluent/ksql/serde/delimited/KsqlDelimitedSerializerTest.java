...
public class KsqlDelimitedSerializerTest {
  ...
  public void shouldSerializeRowCorrectly() {
    // Given:
    final List<?> values = Arrays.asList(1511897796092L, 1L, "item_1", 10.0, new Time(100), new Timestamp(100));
    ...
    assertThat(delimitedString, equalTo("1511897796092,1,item_1,10.0,100,100"));
  }

  @Test
  public void shouldSerializeRowWithNull() {
    // Given:
    final List<?> values = Arrays.asList(1511897796092L, 1L, "item_1", null, null, null);
  ...
  public void shouldSerializeRowCorrectlyWithDifferentDelimiter() {
    ...
    // Then:
    assertThat(new String(bytes, StandardCharsets.UTF_8), is("1511897796092\t1\titem_1\t10.0\t100\t100"));
  }
