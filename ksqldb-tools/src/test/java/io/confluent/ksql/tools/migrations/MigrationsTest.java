...
public class MigrationsTest {
  ...
  public void testApply() throws IOException {
    ...
    // verify current
    final List<StreamedRow> current = makeKsqlQuery("SELECT * FROM " + MIGRATIONS_TABLE + " WHERE VERSION_KEY='CURRENT';");
    ...
    // verify version 1
    final List<StreamedRow> version1 = makeKsqlQuery("SELECT * FROM " + MIGRATIONS_TABLE + " WHERE VERSION_KEY='1';");
    ...
    // verify version 2
    final List<StreamedRow> version2 = makeKsqlQuery("SELECT * FROM " + MIGRATIONS_TABLE + " WHERE VERSION_KEY='CURRENT';");
  ...
  private static void initializeAndVerifyMetadataStreamAndTable(final String configFile) {
    ...
    assertThatEventually(() -> streamDesc.getTopic(), is("default_ksql_" + MIGRATIONS_STREAM));
    ...
    assertThatEventually(() -> tableDesc.getTopic(), is("default_ksql_" + MIGRATIONS_TABLE));
